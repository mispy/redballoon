...
export class SignupForm extends React.Component<{ referringUserSlug?: string }> {
    ...
    render() {
        return <React.Fragment>
            ...
            <p>Helix Nanotechnologies needs you! We recently launched <a target="_blank" href="https://medium.com/@hannu_64912/helixnano-announces-grant-from-schmidt-futures-to-pursue-personalized-cancer-vaccines-323cbbd6bee0">a project backed by Eric Schmidt</a> to supercharge future cancer immunotherapies. Now we need a pioneering scientist to lead it, with the right attitude and skills -- <a target="_blank" href="https://www.helixnano.com/jobs">full role description here</a>.</p>
            <p>You can help us find them. By signing up below with the <span className="text-primary">blue button</span>, you'll get an invite link that you can forward to smart friends in the field, post on Twitter/Facebook/LinkedIn, send to mailing lists of academic departments, or anything else you can think of to find the best candidate.</p>
            ...
            <p>Or if you think <em>you</em> are the right person for the job, just apply using the <span className="text-success">green button</span> below.</p>
